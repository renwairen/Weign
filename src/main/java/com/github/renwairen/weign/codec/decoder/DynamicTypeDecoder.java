...
import com.github.renwairen.weign.codec.DataTypes;
import com.github.renwairen.weign.codec.converter.Converter;
...
public class DynamicTypeDecoder implements Decoder {
    ...
    public JsonNode decode(String data, int offset) {
        ...
        data =
                data.substring(
                        offset + Decoder.HEX_STRING_LENGTH, offset + Decoder.HEX_STRING_LENGTH + length * 2);
