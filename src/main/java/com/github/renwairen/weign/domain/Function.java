...
import com.github.renwairen.weign.codec.encoder.EncoderContext;
import com.github.renwairen.weign.constant.StateMutability;
...
public class Function extends Interface {
    ...
    public Function(InterfaceDescriptor descriptor) {
        ...
        this.outputs = Interface.toParams(descriptor.getOutputs());
    ...
    public JsonNode decode(String data) {
        return Interface.decode(outputs, data);
    }
}
